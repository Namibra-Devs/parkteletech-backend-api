...
class StaffDetailsController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $updatedFiles = FilesInternal::where(
                'staff_detail_id',
                $staffDetail->id
            )->get();
    ...
    public function destroy($id)
    {
        try {
            ...
            return response()->json(
                [
                    'message' =>
                    'Staff detail and associated files deleted successfully.',
                ],
                200
            ); // HTTP 200 - OK
        } catch (ModelNotFoundException $e) {
            ...
            return response()->json(
                [
                    'message' =>
                    'An error occurred while deleting the staff detail.',
                    'error' => $e->getMessage(),
                ],
                500
            ); // HTTP 500 - Internal Server Error
